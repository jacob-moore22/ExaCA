...
show_help() {
    ...
    echo " "
    echo "          full-app                    builds ExaCA from scratch, installing dependencies where necessary."
    echo "          ExaCA                       builds just ExaCA "
...
valid_build_action=("ExaCA" "install-Kokkos" "full-app")
# valid_solver=("SGH")
valid_kokkos_build_types=("serial" "openmp" "pthreads" "cuda" "hip")
valid_machines=("linux")
